...
public class Prog1 {
	...
	public static void main(String[] args) throws MalformedURLException {
		...
		//Scrollable.scrollToText("DISCOVER", driver);
		//Scrollable.scrollToText("Your sleep in Fit", driver);
		
		Scrollable.scrollToText("Follow along with the beat to turn", driver);
	}
